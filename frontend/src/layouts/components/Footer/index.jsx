          ...
          <div className="row">
            ...
            <div className="col-lg-4 col-md-6 mb-4">
              <div className="footer-brand mb-3">
                <span className="footer-logo-text">SPORT</span>
                <span className="badge bg-danger footer-logo-badge">ZY</span>
              </div>
            ...
            {/* Newsletter */}
            <div className="col-lg-4 col-md-6 mb-4">
              <h6 className="footer-title mb-3">Get Our Updates</h6>
              ...
              <form className="newsletter-form">
                <div className="input-group">
                  ...
                  />
                  <button
                    className="btn btn-danger newsletter-btn"
                    type="submit"
                  >
                    Subscribe
                  </button>
              ...
              <div className="payment-methods mt-4">
                <h6 className="payment-title mb-2">We Accept</h6>
